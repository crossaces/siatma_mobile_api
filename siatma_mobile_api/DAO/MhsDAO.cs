...
dbo.MST_MHS_AKTIF.NAMA_MHS, dbo.MST_MHS_AKTIF.ALAMAT, dbo.MST_ORTU.ALAMAT_ORTU, dbo.MST_MHS_AKTIF.TMP_LAHIR, dbo.MST_MHS_AKTIF.TGL_LAHIR, YEAR(GETDATE()) - dbo.MST_MHS_AKTIF.THN_MASUK AS lama, dbo.MST_MHS_AKTIF.ID_PRODI, dbo.MST_MHS_AKTIF.THN_MASUK,
                                ...
                                WHERE (dbo.MST_MHS_AKTIF.NPM = '180709677') AND KD_STATUS_MHS ='A'";
